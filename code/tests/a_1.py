...
model.add_layer(50, relu, relu_diff)
model.add_layer(75, relu, relu_diff)
model.add_layer(50, relu, relu_diff)
...
# set training rate
model.set_learning_rate(.0007)

# reshape y_train
y_train =np.reshape(y_train, (len(y_train), 1))

# train the net
model.fit_stochastic_grad(X_train, y_train, epochs=200, batch_size=80)
