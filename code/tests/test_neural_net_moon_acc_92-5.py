...
# it gives a pretty good accuracy of 92,5 % !
#
#
...
model.add_layer(15, relu, relu_diff)
model.add_layer(53, relu, relu_diff)
model.add_layer(7, relu, relu_diff)
...
# train the net
model.fit(X_train, y_train, iters=1000, batch_size=80)
